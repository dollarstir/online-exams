...
<head>
        ...
        <title>OES | Manage Lecturer</title>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Lecturer</a></li>										
										   ...
										   $sql = "SELECT * FROM tbl_users WHERE role = 'lecturer'";
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_lecturer.php" method="POST">
