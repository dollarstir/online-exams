     ...
     <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-login">
        ...
        <main class="page-content">
            ...
            <!-- <img src="assets/images/ex.jpg" alt="" height="100" width="250"> -->
                <div id="main-wrapper" style="background-color:purple !important;border-radius:10px;">
                    <div class="row">
                        <div class="col-md-4 center">
                            <div class="login-box">
                                <a href="./" class="logo-name text-lg text-center" style="color:#fff;">Online Examination System</a>
                                <p class="text-center m-t-md" style="color:#fff;">Please login into your account.</p>
